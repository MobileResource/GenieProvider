...
+ (UIColor *)jsq_messageBubbleWhiteColor
{
    return [UIColor colorWithHue:0.0 / 360.0f
                      saturation:0.0f
                      brightness:1.0f
                           alpha:1.0f];
}
...
+ (UIColor *)jsq_messageBubbleSenderColor{
    return [UIColor colorWithHue:41.0f / 360.0f
                      saturation:0.95f
                      brightness:1.0f
                           alpha:1.0f];
}

+ (UIColor *)jsq_messageBubbleOpponentColor{
    return [UIColor colorWithHue:244.0f / 360.0f
                      saturation:0.55f
                      brightness:0.9f
                           alpha:1.0f];
}
