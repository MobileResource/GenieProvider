...
+ (UIButton *)defaultSendButtonItem
{
    ...
    [sendButton setTitleColor:[UIColor jsq_messageBubbleWhiteColor] forState:UIControlStateNormal];
    [sendButton setTitleColor:[[UIColor jsq_messageBubbleWhiteColor] jsq_colorByDarkeningColorWithValue:0.1f] forState:UIControlStateHighlighted];
    ...
    sendButton.tintColor = [UIColor jsq_messageBubbleWhiteColor];
